...
public class ImportDataFromApi {
    ...
    public void importDataFromFile () throws IOException {
        JSONObject body = new JSONObject(new String(Files.readAllBytes(Paths.get("src/1.json"))));
...
//        String import34 =  "class.address.street.sum()";
        String import34 =  "class.address.street.findAll()"; //Как вывести через пробел? (LeninMarxPobedy)
        System.out.println("qqqqqq   " + JsonPath.from(String.valueOf(body)).getString(import34));
